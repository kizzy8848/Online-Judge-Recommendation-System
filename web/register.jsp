...
<div>
    <form action="Register" method="post">
        ...
        <div class="form-group">
            <center>
                <label for="password1"></label><span id="password1span"></span><input type="text" class="form-control" id="password1" name="password"  placeholder="Please input password" style="width: 400px;" maxlength="20">
            </center>
        </div>
