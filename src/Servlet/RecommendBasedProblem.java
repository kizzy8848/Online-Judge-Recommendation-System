...
import Recommender.result.RecommendBasedProblems;
...
@WebServlet(name="RecommendBasedProblem",urlPatterns = "/RecommendBasedProblem")
public class RecommendBasedProblem extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            RecommendBasedProblems recommendBasedProblems = new RecommendBasedProblems();
           ...
           // System.out.println(username);
            ...
            reResult = recommendBasedProblems.recommendResult(username);
            ...
            //System.out.println(recommendProblemJson);
